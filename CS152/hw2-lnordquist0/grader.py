...
RUBRIC = [
          ("Exercise 1: Flip", "flip", 5.0),
          ("Exercise 2: Shift", "shift", 5.0),
          ("Exercise 3: First letter of each word", "first_letter", 10.0),    
          ("Exercise 4: Count zeros and runs", "count_zeros_and_runs", 5.0),
          ("Exercise 5: Saves space", "saves_space", 5.0), 
          ("Exercise 6: Encode", "encode", 15.0),  
          ("Exercise 7: Decode", "decode", 15.0) 
         ]
